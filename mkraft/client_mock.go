...
func (m *MockInternalClientIface) SendAppendEntries(ctx context.Context, req *rpc.AppendEntriesRequest) RPCRespWrapper[*rpc.AppendEntriesResponse] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendAppendEntries", ctx, req)
	ret0, _ := ret[0].(RPCRespWrapper[*rpc.AppendEntriesResponse])
	return ret0
}
...
func (m *MockInternalClientIface) SendRequestVoteWithRetries(ctx context.Context, req *rpc.RequestVoteRequest) chan RPCRespWrapper[*rpc.RequestVoteResponse] {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "SendRequestVoteWithRetries", ctx, req)
	ret0, _ := ret[0].(chan RPCRespWrapper[*rpc.RequestVoteResponse])
	return ret0
}
