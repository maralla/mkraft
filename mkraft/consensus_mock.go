...
func (m *MockConsensusIface) AppendEntriesSendForConsensus(ctx context.Context, peerReq map[string]*rpc.AppendEntriesRequest, currentTerm uint32) (*AppendEntriesConsensusResp, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AppendEntriesSendForConsensus", ctx, peerReq, currentTerm)
...
func (mr *MockConsensusIfaceMockRecorder) AppendEntriesSendForConsensus(ctx, peerReq, currentTerm any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "AppendEntriesSendForConsensus", reflect.TypeOf((*MockConsensusIface)(nil).AppendEntriesSendForConsensus), ctx, peerReq, currentTerm)
}
